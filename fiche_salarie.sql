...
CREATE TABLE IF NOT EXISTS `competences` (
  ...
  `nomCompetence` char(32) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `salarie` (
  ...
  `nomSalarie` char(32) CHARACTER SET utf8 NOT NULL,
  `prenomSalarie` char(32) CHARACTER SET utf8 NOT NULL,
  `civilite` char(32) CHARACTER SET utf8 NOT NULL,
  `email` char(128) CHARACTER SET utf8 NOT NULL,
  `telephonne` varchar(15) CHARACTER SET utf8 NOT NULL,
  `adresse` char(128) CHARACTER SET utf8 NOT NULL,
  `codePostal` int(5) NOT NULL,
  `ville` char(128) CHARACTER SET utf8 NOT NULL,
  `site` smallint(6) NOT NULL,
  `competences` text CHARACTER SET utf8,
...
CREATE TABLE IF NOT EXISTS `sites` (
  ...
  `nomSite` char(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`idSite`)
